...
const skills = [
  ...
  "FastAPI", "LangChain", "LangGraph", "VectorDB", "ChromaDB",
]
        ...
        <div ref={contentRef} className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="glass rounded-3xl p-8 relative overflow-hidden card-hover">
              ...
              <div className="aspect-square max-w-md mx-auto rounded-2xl bg-gradient-to-br from-primary/10 via-secondary to-primary/5 overflow-hidden relative">
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="text-8xl font-bold gradient-text opacity-60">AC</div>
                </div>
                {/* Decorative elements */}
          ...
          <div className="space-y-8">
            ...
            <p className="about-animate text-lg text-muted-foreground text-pretty">
              I&apos;m Md Sufiyan Ali, a Full Stack and Generative AI Developer specializing in React, Next.js, FastAPI, Django, LangChain, and RAG applications.
            </p>

            <p className="about-animate text-lg text-muted-foreground text-pretty">
            <span className="gradient-text font-bold text-xl">I build intelligent web applications</span>, AI chatbots, and end-to-end solutions
             that combine modern frontend experiences with scalable backend systems. My focus is on creating practical AI-powered products that deliver real value and solve real-world problems.
            </p>

            <p className="about-animate text-lg text-muted-foreground text-pretty"> <span className="gradient-text text-xl font-bold">Currently exploring</span> advanced AI agents, LLM applications, and modern software engineering practices while continuously building and learning.</p>

            {/* Skills */}
            <div className="skills-container space-y-4">
              <h3 className="about-animate font-semibold text-foreground">Technologies I Work With</h3>
